...
canvas.addEventListener('mousedwn', function(event){
   mouse.click = false;
...
playerLeft.src = 'fish_red_swim_left.png';
const playerRight = new Image();
playerRight.src = 'fish_red_swim_right.png';
    ...
    update(){
       ...
       if (this.x >= mouse.x){
        ctx.drawImage(playerLeft, this.frameX * this.spriteWidth, this.frameY * this.
            spriteHeight, this.spriteWidth, this.spriteHeight, 0 - 60, 0 - 45, this.
 ...
 class Enemy {
    ...
    draw(){
       /* ctx.fillStyle = 'red';
        ...
        ctx.arc(this.x, this.y, this.radius, 0, Math.PI * 2);
        ctx.fill();*/
        ctx.drawImage(enemyImage, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight, this.x - 60, this.y - 70, this.spriteWidth / 5, this.spriteHeight / 5);
    }
    update(){
        this.x -= this.speed;
